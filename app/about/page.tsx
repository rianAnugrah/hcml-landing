export default function AboutPage() {
    return (
      <div className="bg-slate-900 min-h-screen">
        {/* Header Section */}
        <div className="bg-slate-900 py-16 px-4 sm:px-6 md:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white tracking-wide mb-4">
              About <span className="font-bold text-blue-500">HCML</span>
            </h1>
